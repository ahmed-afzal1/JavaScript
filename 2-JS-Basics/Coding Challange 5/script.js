/******
 Remember the tip calculator challange? Let's create a more advanced version using everything
 we learned!
 ...
 4. As an output, create 1) a new array containing all tips, and 2) an array containing final 
    paid ammounts (bill+tip). HINT: Start with two empty arrays [] as properties and then fill
    them up in the loop
    
Extra After Finishing: Mark's family also went on a holiday, going to 4 restaurants. The bills
...
$100 and $300, and 25% if the bill is more than $300(different than john)
 ...
 6. Create a function(not a method) to calculate the average of a given array of tips. HINT: Loop
    over the array, and in each iteration store the current sum in a variable (starting from 0). After You have the sum of the array, divide it by the number of elements in it (that's how you calculate average)
